<template>
    <div class="blog-content">
        <div class="ui container animate__animated animate__backInUp">
            <!-- 头部信息 -->
            <div class="ui top attached segment blog-content-box">
                <div class="ui horizontal link list">
                    <div class="item ">
                        <img src="https://s1.wallpapermaiden.com/image/2019/06/12/misaka-mikoto-to-aru-majutsu-no-index-magic-school-uniform-anime-33952.jpeg"
            ...
            <!-- 图片区域 -->
            <div class="ui attached segment blog-content-box">
            ...
            <div class="ui attached segment blog-content-box">
                ...
                <div class="ui right aligned basic segment">
                    <div class="ui  label basic blog-content-box">原创</div>
                </div>
                <!-- 标题 -->
                ...
                <!-- 正文 -->
                <div id="content" class="typo typo-selection blog-container">
                    <div id="wrapper" class="typo typo-selection">
                        ...
                        <p>目前已有像百姓网等全面使用 <i class="serif">Typo.css</i> 的项目，测试平台的覆盖，特别是在<abbr
                            ...
                            的开发。加入方法：<a href="https://github.com/sofish/Typo.css">参与 <i class="serif">Typo.css</i>
                                开发</a>。如有批评、建议和意见，也随时欢迎给在
                            Github 直接提 <a href="https://github.com/sofish/Typo.css/issues">issues</a>，或给<abbr
                                title="Sofish Lin, author of Typo.css" role="author">我</abbr>发<a
                        ...
                        <p>此外，在对「人不知，而不愠」一句的解释中，也有人认为，「人不知」的后面没有宾语，人家不知道什么呢？当时因为孔子有说话的特定环境，他不需要说出知道什么，别人就可以理解了，却给后人留下一个谜。有人说，这一句是接上一句说的，从远方来的朋友向我求教，我告诉他，他还不懂，我却不怨恨。这样，「人不知」就是「人家不知道我所讲述的」了。这样的解释似乎有些牵强。
                        </p>
                        ...
                        <pre class="line-numbers"><code class="language-css">p { color: red }</code></pre>
                        <pre><code class="language-css line-numbers">/* 标题应该更贴紧内容，并与其他块区分，margin 
                        ...
                        <p><i class="serif">Typo.css</i> 基于 <a href="//zh.wikipedia.org/wiki/MIT_License">MIT
                                License</a> 开源，使用代码只需说明来源，或者引用
                ...
                <div class="ui payQR flowing popup transition hidden">
                    <div class="ui images">
                        <div class="image">
                            <img class="ui rounded bordered image" style="width: 120px;height: 120px;"
                                src="../../assets/images/alipay.jpg" alt="">
                        </div>
                        <div class="image">
                            <img class="ui rounded bordered image" style="width: 120px;height: 120px;"
                                src="../../assets/images/WeChatpay.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <!-- 博客信息 -->
            <div class="ui attached positive message  blog-content-box">
                <div class="ui middle aligned grid">
                    <div class="eleven wide column">
                        <i class="list">
                            <li>作者：管理员（联系作者）</li>
                            <li>发表时间：2022-09-03 13:19</li>
                            <li>版权声明：自由转载-非商用-非衍生-保持署名</li>
                            <li>公众号转载：请在文末添加作者公众号二维码</li>
                        </i>
                    </div>
                    <div class="five wide column">
                        <img src="../../assets/images/wx.jpg" class="ui right floated rounded bordered image"
                            style="width: 120px">
                    </div>
                </div>
            </div>
            <!-- 留言区域 -->
            <div class="ui bottom attached segment blog-content-box">
                <!-- 留言区域列表 -->
                ...
                <div class="ui form">
                    <div class="field">
                        <textarea name="content" placeholder="请输入评论信息..." class="transparents"></textarea>
                    </div>
                    <div class="fields">
                        <div class="field">
                            <div class="ui left icon input">
                                <i class="user icon"></i>
                                <input class="transparents" type="text" name="nickname" placeholder="姓名">
                            </div>
                        </div>
                        <div class="field">
                            <div class="ui left icon input">
                                <i class="mail icon"></i>
                                <input class="transparents" type="text" name="mail" placeholder="邮箱">
                            </div>
                        </div>
                        <div class="field ">
                            <button class="ui button comment-fabu transparents"><i class="edit icon"></i>发布</button>
                        </div>
                    </div>
                </div>
            </div>
...
import { swap } from '../../../jQuery_method/swap'
...
.blog-content {
    ...
    .transparents {
        background: rgba(255, 255, 2255, 0.1) !important;
    }
}
